...
export function FeaturedProjectsSection() {
  return (
    <section className="flex flex-col gap-6 mt-32 bg-purple-200 w-full p-32">
      <h2 className="font-display text-3xl font-extrabold mb-8">
        Featured Projects
...
const ProjectCard = ({ project }: { project: Project }) => {
  return (
    <article className="flex flex-col bg-white  overflow-hidden shadow-md hover:shadow-lg">
      <div className="p-4">
        <img
          src={project.img}
